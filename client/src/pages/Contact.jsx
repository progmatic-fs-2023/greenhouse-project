  ...
  return (
    <div className="contact_main_container">
      <div className="contact_container">
        <h2>Contact Us</h2>
        {sending && <p>Sending...</p>}
        {sent && <p className='message_sent'>Thank you for reaching out to us! We will get back to you as soon as possible. 🙂 <br /><br /> Get <a href="/quizmoduls" style={{textDecoration: 'underline'}}>quizzing.</a></p>}
